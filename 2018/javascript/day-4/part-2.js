...
const minutesAsleepperGuardsArrayWithMaxMinute =
  minutesAsleepperGuardsArrayWithCount.map(
...
const minutesAsleepperGuardsArrayWithMaxMinuteSorted =
  minutesAsleepperGuardsArrayWithMaxMinute.sort(
    (a, b) => {
...
const theFinalMaxiSleeperGuardOnThisMinute =
  minutesAsleepperGuardsArrayWithMaxMinuteSorted.pop();
